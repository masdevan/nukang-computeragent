...
SKILL_DESCRIPTIONS = {
    ...
    "drag": "Drag with the left mouse button",
    "find_and_click": "Scroll until text is visible, then click it",
    "try_click": "Try click points around coordinates until success",
